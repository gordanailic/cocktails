...
class CocktailViewModel @Inject constructor(
    ...
    private val handler = CoroutineExceptionHandler { _, exception ->
        _cocktails.value = Resource.Error(application.applicationContext.resources.getString(R.string.failed_fetch)+ exception.message)
    }
        ...
        viewModelScope.launch(handler) {
            _cocktails.value = Resource.Loading()
                ...
                if (response.isSuccessful) {
                    ...
                    _cocktails.value = Resource.Error(application.applicationContext.resources.getString(R.string.failed_fetch))
                }
        }
    }
